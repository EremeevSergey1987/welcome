        ...
        <div class="row">
            ...
            <form method="post" action="input_text.php">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="author" name="author" value="<?php if($_POST){ echo $_POST['author'];}?>" type="text" placeholder="Author" aria-label="Author">
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Email address</label>
                    <input type="email" value="<?php if($_POST){ echo $_POST['email'];}?>" class="form-control" id="email" name="email" placeholder="name@mail.ru" aria-describedby="emailHelp">
